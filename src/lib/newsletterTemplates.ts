    ...
    generateHtml: (content: string, subject: string) => `
      <div style="max-width: 600px; margin: 0 auto; padding: 32px 24px;">
        ...
        <p style="color: #a1a1aa; font-size: 12px; text-align: center;">
          © ${new Date().getFullYear()} Artistry.ng • <a href="https://artistryng.lovable.app" style="color: #c026d3;">Visit Website</a>
        </p>
      </div>
    `,
  },
    ...
    generateHtml: (content: string, subject: string) => `
      <div style="max-width: 600px; margin: 0 auto;">
        ...
        <p style="color: #52525b; font-size: 12px; text-align: center; margin-top: 24px;">
          © ${new Date().getFullYear()} Artistry.ng
        </p>
      </div>
    `,
  },
    ...
    generateHtml: (content: string, subject: string) => `
      <div style="max-width: 600px; margin: 0 auto; padding: 24px;">
        <div style="text-align: center; margin-bottom: 24px;">
          ...
          <h1 style="color: #18181b; font-size: 20px; margin: 8px 0 0 0;">ARTISTRY.NG</h1>
        </div>
        ...
        <div style="text-align: center; margin-top: 24px;">
          <a href="https://artistryng.lovable.app" style="display: inline-block; background: linear-gradient(135deg, #c026d3, #7c3aed); color: #fff; text-decoration: none; padding: 12px 28px; border-radius: 8px; font-weight: 600;">
            Explore Artistry
          </a>
        </div>
    ...
    generateHtml: (content: string, subject: string) => `
      <div style="max-width: 600px; margin: 0 auto; background-color: #0a0a0b; border-radius: 16px; overflow: hidden;">
        ...
        <div style="background-color: #18181b; padding: 20px 24px; text-align: center; border-top: 1px solid #27272a;">
          <a href="https://artistryng.lovable.app" style="color: #c026d3; text-decoration: none; font-size: 13px;">
            Visit Artistry.ng
          </a>
      ...
      <div style="max-width: 600px; margin: 0 auto;">
        ...
        <div style="background-color: #ffffff; padding: 32px 24px;">
          ...
          <div style="text-align: center; margin-top: 32px;">
            <a href="https://artistryng.lovable.app" style="display: inline-block; background: #c026d3; color: #fff; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 15px;">
              Learn More
            </a>
          </div>
        </div>
        <div style="background-color: #f4f4f5; padding: 20px; text-align: center;">
          <p style="color: #71717a; font-size: 12px; margin: 0;">
            © ${new Date().getFullYear()} Artistry.ng • <a href="https://artistryng.lovable.app" style="color: #c026d3; text-decoration: none;">Unsubscribe</a>
          </p>
        </div>
      </div>
    `,
  },
  {
    ...
    generateHtml: (content: string, subject: string) => `
      <div style="max-width: 600px; margin: 0 auto; background: #0a0a0b;">
        ...
        <div style="padding: 32px 24px; text-align: center;">
          <a href="https://artistryng.lovable.app/discover" style="display: inline-block; border: 2px solid #c026d3; color: #c026d3; text-decoration: none; padding: 12px 28px; border-radius: 25px; font-weight: 500;">
            Discover More Creatives
          </a>
        </div>
        <div style="padding: 20px; text-align: center; border-top: 1px solid #27272a;">
          <p style="color: #52525b; font-size: 11px; margin: 0;">
            Artistry.ng • Connecting Nigeria's Creative Community
          </p>
        </div>
      </div>
    `,
